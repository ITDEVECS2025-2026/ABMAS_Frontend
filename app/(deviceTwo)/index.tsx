  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.cardRow}>
        ...
        <ParameterCard label="Keasaman" value={Number(latestMessage.pH || 0).toFixed(1)} unit="pH" icon={<Text style={styles.iconEmoji}>🧪</Text>} />
      </View>

      {/* 3. Statistik Lingkungan */}
      <Text style={styles.sectionTitle}>🏡 Statistik Lingkungan</Text>
