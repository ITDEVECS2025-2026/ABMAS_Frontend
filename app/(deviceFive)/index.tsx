...
export default function DeviceFiveScreen() {
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
      ...
      <View style={styles.header}>
        <Text style={styles.title}>🌳 Device 5 Monitor</Text>
        <Text style={styles.subtitle}>Real-time Soil & Enviromental Data</Text>
        {/* Ambil timestamp dari data atom */}
      ...
      <View style={styles.statusRow}>
        ...
        <View style={styles.statusIndicatorRow}>
          <View style={[
            styles.statusDot,
            { backgroundColor: messages[0] ? '#10b981' : '#ef4444' } // Hijau jika ada data, merah jika tidak
          ]} />
          <Text style={[
            styles.statusText,
            {
...
// Tambahkan style baru ke StyleSheet Anda
